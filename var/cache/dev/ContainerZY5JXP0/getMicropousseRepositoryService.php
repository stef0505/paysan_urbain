...
// Returns the private 'App\Repository\MicropousseRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/MicropousseRepository.php';

return $this->privates['App\\Repository\\MicropousseRepository'] = new \App\Repository\MicropousseRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
