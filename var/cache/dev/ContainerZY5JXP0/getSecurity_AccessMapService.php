...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/loginAdmin'), [0 => 'IS_AUTHENTICATED_ANONYMOUSLY'], NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/register'), [0 => 'ROLE_SUPER_ADMIN', 1 => 'IS_AUTHENTICATED_ANONYMOUSLY'], NULL);
