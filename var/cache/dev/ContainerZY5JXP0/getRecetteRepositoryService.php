...
// Returns the private 'App\Repository\RecetteRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/RecetteRepository.php';

return $this->privates['App\\Repository\\RecetteRepository'] = new \App\Repository\RecetteRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
