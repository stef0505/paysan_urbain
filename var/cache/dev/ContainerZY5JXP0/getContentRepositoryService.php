...
// Returns the private 'App\Repository\ContentRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ContentRepository.php';

return $this->privates['App\\Repository\\ContentRepository'] = new \App\Repository\ContentRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
