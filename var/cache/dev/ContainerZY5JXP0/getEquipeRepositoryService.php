...
// Returns the private 'App\Repository\EquipeRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/EquipeRepository.php';

return $this->privates['App\\Repository\\EquipeRepository'] = new \App\Repository\EquipeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
